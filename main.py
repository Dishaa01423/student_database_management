...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        edit_info = QAction(QIcon("icons/icons/search.png"),"Search", self)
        edit_menu_item.addAction(edit_info)
        edit_info.triggered.connect(self.search)
...
class InsertDialog(QDialog):
    def __init__(self):
        ...
        courses = ["Astronomy","Physics","Chemistry","Biology"]
...
class EditDialog(QDialog):
    ...
    def update_student(self):
        connection = DatabaseConnection().connect()
        cursor = connection.cursor()
        cursor.execute("UPDATE students SET name =?, mobile =? WHERE id=?",
